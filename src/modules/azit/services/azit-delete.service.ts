// src/modules/azit/services/azit-delete.service.ts
...
import { Result, ok, notFound, forbidden, internalServerError } from "../../../common/types/result.type";
import { deleteFileFromS3 } from "../../../common/utils/file-util";
import { AzitUserRole } from "@prisma/client";

@injectable()
export class AzitDeleteService {
  constructor(
